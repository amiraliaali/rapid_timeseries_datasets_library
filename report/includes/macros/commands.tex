...
\lstdefinestyle{python}{
    ...
    morekeywords={forecasting_data_set, forecasting_data_set_res, classification_data_set, classification_data_set_res, dataset, dataset_type, past_window, future_horizon, stride, labels, batch_size, num_workers, downsampling_rate, impute_strategy, splitting_strategy, splitting_ratios, fore, clas, data, fore_res, clas_res}, % List of variables
    ...
    morekeywords={np, ndarray, LeaveNaN, InOrder, ForwardFill, Median, Random},
...
\lstdefinestyle{rust}{
    ...
    keywordstyle=\color{variableColor},
    classoffset=3, % Separate class styling
    morekeywords={ArrayBase, Dim, PyResult, DataMut, Elem, S, Ok, Python, SplittingStrategy, ImputeStrategy}, % List of classes
    keywordstyle=\color{classColor},
    classoffset=2, % Reset for methods
    ...
    keywordstyle=\color{methodColor},
    classoffset=1, % Reset for types
    morekeywords={np, ndarray, LeaveNaN, InOrder, ForwardFill, Temporal, Random, Mean, Median, BackwardFill},
    keywordstyle=\color{typeColor},
    showstringspaces=false,
}
...
\newcommand{\imputeStrategy}{\rustFunc{impute}{strategy}}
...
\newcommand{\trainProp}{\rustVar{train\_prop}}
\newcommand{\valProp}{\rustVar{val\_prop}}
\newcommand{\testProp}{\rustVar{test\_prop}}
\newcommand{\factor}{\rustVar{factor}}

% libraries
\newcommand{\numpy}{\rustLibrary{numpy}}
\newcommand{\torch}{\rustLibrary{torch}}
\newcommand{\pyclass}{\rustLibrary{\#pyo3::pyclass}}
