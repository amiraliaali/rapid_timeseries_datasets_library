...
In case of \textbf{In-Order splitting}, as shown in \autoref{fig:in_order_split}, we follow a similar approach, but we do not shuffle the instances. The steps are as follows:
\begin{enumerate}
    \item Validate the proportions of the training, validation, and test sets.
