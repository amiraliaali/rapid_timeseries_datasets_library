...
\input{includes/macros/commands.tex}
...
\begin{frame}
    \frametitle{Total setup durations I}
        ...
        \end{itemize}
    \only<3>{
    \begin{figure}[H]     \includegraphics[scale=0.3]{presentation/figures/benchmarking/setup/four/gun.png}     \caption{Setup durations on GunPoint}     \label{fig:setup-gun-four}
    \end{figure}}
...
\begin{frame}
    \frametitle{Total setup durations II}
        ...
        \end{itemize}
    \only<1>{
    \begin{figure}[H]     \includegraphics[scale=0.3]{presentation/figures/benchmarking/setup/three/gun.png}     \caption{Setup durations on GunPoint}     \label{fig:setup-gun-three}
    \end{figure}}
...
\begin{frame}
    \frametitle{Total iteration durations}
        ...
        \end{itemize}
    \only<3>{
    \begin{figure}[H]     \includegraphics[scale=0.3]{presentation/figures/benchmarking/iteration/four/gun.png}     \caption{Iteration durations on GunPoint}     \label{fig:iter-gun-four}
    \end{figure}}
    \visible<4->{ \textbf{Explanation:}}
    \begin{itemize}
...
\begin{frame}
    \frametitle{Imputing durations}
        ...
        \end{itemize}
    \only<2>{
    \begin{figure}[H]     \includegraphics[scale=0.3]{presentation/figures/benchmarking/methods_gunpoint/imputation_comparison.png}     \caption{Imputing durations on GunPoint}    \label{fig:impute-gun}
    \end{figure}}
...
\begin{frame}
    \frametitle{Normalization durations}
        ...
        \end{itemize}
    \only<2>{
    \begin{figure}[H]     \includegraphics[scale=0.3]{presentation/figures/benchmarking/methods_gunpoint/normalization_comparison.png}     \caption{Normalization durations on GunPoint}    \label{fig:norma-gun}
    \end{figure}}
...
\begin{frame}
    \frametitle{Standardization durations}
        ...
        \end{itemize}
    \only<2>{
    \begin{figure}[H]     \includegraphics[scale=0.3]{presentation/figures/benchmarking/methods_gunpoint/standardization_comparison.png}     \caption{Standardization durations on GunPoint}    \label{fig:stand-gun}
    \end{figure}}
    \visible<3->{ \textbf{Explanation:}}
    \begin{itemize}
        \item<3-> \textbf{Again:}
...
\begin{frame}
    \frametitle{Downsampling durations}
        ...
        \end{itemize}
    \only<2>{
    \begin{figure}[H]     \includegraphics[scale=0.3]{presentation/figures/benchmarking/methods_gunpoint/downsampling_comparison.png}     \caption{Downsampling durations on GunPoint}    \label{fig:down-gun}
    \end{figure}}
    \visible<3->{ \textbf{Explanation:}}
    \begin{itemize}
...
\begin{frame}
    \frametitle{Data collection durations}
        ...
        \end{itemize}
    \only<2>{
    \begin{figure}[H]     \includegraphics[scale=0.3]{presentation/figures/benchmarking/methods_gunpoint/data_collection_comparison.png}     \caption{Data collection durations on GunPoint}    \label{fig:col-gun}
    \end{figure}}
    \visible<3->{ \textbf{Explanation:}}
    \begin{itemize}
